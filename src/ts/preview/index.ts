...
export class Preview {
    ...
    constructor(vditor: IVditor) {
        ...
        console.warn('previewElement',this.element, previewElement)
        this.element.appendChild(previewElement)
        /**
         * action 添加在后面有bug， 因为预览内容会添加到最后一个节点就是action是不行的
         * 当前也不需要 action 这个操作，暂时注释掉
         */
        ...
        //         actionHtml.push(
        //             `<button type="button" data-type="${action.key}" class="${
        //                 action.className
        //             }"${
        ...
        // console.warn(this.element, actionElement)
        ...
        //         this.copyToX(
        //             vditor,
        //             this.element.lastElementChild.cloneNode(
        //                 true
        //             ) as HTMLElement,
        //             type
        //         )
        ...
        //         previewElement.parentElement.clientWidth
        //     ) {
        //         previewElement.style.width = "auto"
        //     }
        //     this.render(vditor)
    ...
    public render(vditor: IVditor, value?: string) {
        ...
        if (
            ...
            console.warn('render value. empty')
            this.element.lastElementChild.innerHTML = ""
            return
        }

        // console.warn('render...', vditor.options.preview.url)
    ...
    private afterRender(vditor: IVditor, startTime: number) {
        ...
        highlightRender(
            ...
            vditor.preview.element.lastElementChild as HTMLElement,
            vditor.options.cdn
        )
        mermaidRender(
            vditor.preview.element.lastElementChild as HTMLElement,
